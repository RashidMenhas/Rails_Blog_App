...
RSpec.describe Like, type: :model do
  before :each do
    @author = User.new(name: 'Menhas',
                       photo: 'https://res.cloudinary.com/highereducation/images/w_1024,h_683,c_scale/f_auto,q_auto/v1669994566/BestColleges.com/web-developer-vs-software-engineer-man-with-laptop/web-developer-vs-software-engineer-man-with-laptop-1024x683.jpg', bio: 'Full-stack software developer')
